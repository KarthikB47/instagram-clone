...
import 'package:stream_agram/components/new_post/new_post_screen.dart';
import 'package:stream_agram/components/profile/profile.dart';
import 'package:stream_agram/components/upload_new_Post/upload_post_screen.dart';
...
class HomeScreen extends StatefulWidget {
  ...
  static const List<Widget> _homePages = <Widget>[
    ...
    // Center(child: Text('Add_UploadPage')),
    UploadNewPostScreen(),
    Center(child: Text('FavotitePage')),
    ProfilePage(),
