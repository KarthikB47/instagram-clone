...
class UploadNewPostScreen extends StatefulWidget {
  /// Create a [UploadNewPostScreen].
  const UploadNewPostScreen({Key? key}) : super(key: key);

  /// Material route to this screen.
  static Route get route =>
      MaterialPageRoute(builder: (_) => const UploadNewPostScreen());

  @override
  _UploadNewPostScreenState createState() => _UploadNewPostScreenState();
}

class _UploadNewPostScreenState extends State<UploadNewPostScreen> {
  ...
  Future<void> _postImage() async {
    if (_pickedFile == null) {
      context.removeAndShowSnackbar('Please get the ');
      return;
    }
