...
extension DemoAppUserX on DemoAppUser {
  ...
  Token? get token => <DemoAppUser, Token>{
        DemoAppUser.sahil: const Token(
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NjMyNDgxMTYsInVzZXJfaWQiOiJzYWhpbC1rdW1hciJ9.ARqx04IkcrBQFpmKK1aVdNnoLvxsxHayG955ZTFkYcs'),
        DemoAppUser.sacha: const Token(
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NjMyNDgwOTIsInVzZXJfaWQiOiJzYWNoYS1hcmJvbmVsIn0.8ymERQJtDnR96cUtaeAU-BWX5UwZW8n-toEd5Yp18Ic'),
        DemoAppUser.reuben: const Token(
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NjMyNDgxMDksInVzZXJfaWQiOiJyZXViZW4tdHVybmVyIn0.1iAdhkZjZDMHs-C16L7nmBJCk7YVdmENBuC3EZBG-9Y'),
        DemoAppUser.gordon: const Token(
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NjMyNDgxMDEsInVzZXJfaWQiOiJnb3Jkb24taGF5ZXMifQ.Wtt563rhkv2oscAesiqNqN6z0nrwKQVrgdZkMTBftyM'),
      }[this];
}
